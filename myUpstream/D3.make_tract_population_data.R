...
myACS_year1 <- 2012 # For 2008-2012
myACS_year2 <- 2017 # For 2013-2017
myACS_year3 <- 2019 # Temporarily use this for 2018-2022
...
`a.pop5_2008-2012` <- getPop(myACS_year1) %>% mutate(GEOID = ifelse(GEOID == "06037930401", 
                                                                    "06037137000", GEOID))
`a.pop5_2013-2017` <- getPop(myACS_year2)
`a.pop5_2018-2022` <- getPop(myACS_year3)
