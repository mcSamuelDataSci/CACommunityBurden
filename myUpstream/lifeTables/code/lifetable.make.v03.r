...
# history: 
#  v03 2018.10.4 rewritten to use acs 5 year data for tracts and up. simplified lt 
#				 generated by pooling exposure and deaths... quick and dirty.
...
## 3.1	calculate how many years of exposure data required 
