...
only LA and Ala records  
  
c.t1      <- calculateYLLmeasures(c("LJH","year","sex","lev0"),"lev0")
c.t2      <- calculateYLLmeasures(c("LHJ","year","sex","lev1"),"lev1")
c.t3      <- calculateYLLmeasures(c("LHJ","year","sex","lev2"),"lev2")
c.t4      <- calculateYLLmeasures(c("LHJ","year","sex","lev3"),"lev3")
datRegion <- bind_rows(c.t1,c.t2,c.t3,c.t4)
