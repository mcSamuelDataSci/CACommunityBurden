...
options(tigris_class = "sf")  # Read shape files as Simple Features objects
...
tr_ca   <- tracts(state = "CA", cb = TRUE)  # 8043 tracts  # Obtain tracts boundary tiger files from Census
