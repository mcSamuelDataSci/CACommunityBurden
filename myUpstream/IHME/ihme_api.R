...
# On my machine, the resulting data set from this function only has the first measure specified (in this case measureID 1, Deaths)
...
# This function shows what happens when too much data is requested on my machine. 
# Looks like it is a memory issue or something related.
