...
TAB_INPUTS <- list("homeTab"=c(),
                   ...
                   "deathHospEDTab" = c("ourOnlyPNGDownload", "myLHJ", "myStrata","mySort", "myMeasureAgeRaceFocus", "suppressionNote"),
                   ...
                   "hospitalDischargeTab"=c("ourDownloads", "myLHJ", "mySex", "myN", "myOSHPDtype"),
