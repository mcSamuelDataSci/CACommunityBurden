...
-   ICD-10 Mapping
    ...
    -   **NOTE:** In order to distinguish between deaths caused by the "Public Health Level" condition "Alzheimer's disease and other dementias", after consulting with clinicians and referencing [a research paper](https://pubmed.ncbi.nlm.nih.gov/31112120/), we have created the following "Detail Level" subgroups:
