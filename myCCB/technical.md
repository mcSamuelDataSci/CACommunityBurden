...
-   Death data
    ...
    -   Provided by California Department of Public Health (CDPH), Center for Health Statistics and Informatics (CHSI) [CDPH/CHSI/Death Files](https://www.cdph.ca.gov/Programs/CHSI/Pages/Data-Applications.aspx) (with key information and differences about these files [here)](https://www.cdph.ca.gov/Programs/CHSI/CDPH%20Document%20Library/Death_Data_Source_Comparison.xlsx).
...
-   Population data
    ...
    -   For **counties**, all population denominator data are from the California Department Department of Finance (DOF). For 2000-2009 data are "[California and Counties Population by Age, Race/Hispanics, and Gender: 2000--2010](https://www.dof.ca.gov/forecasting/demographics/Estimates/Race-Ethnic/2000-2010/)" estimates and for 2010 through 2020 data are [Complete State and County Projections](https://www.dof.ca.gov/forecasting/demographics/Projections/) (Table P-3).
