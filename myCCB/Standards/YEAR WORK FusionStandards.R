...
##  
yearG3  <- "2018-2020"  # FIX

yearGrp3_num <- t.year3 : currentYear
...
tH.year3             <- currentYear_hosp_ed - 3

yearGrp3_hosp_ed     <- paste0(tH.year3, "-", currentYear_hosp_ed)
yearGrp3_hosp_ed_num <- tH.year3 : currentYear_hosp_ed
