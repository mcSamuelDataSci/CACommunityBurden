...
# Input selections on each tab  ----------------------------           
 ...
 # myCAUSE
 conditionalPanel(condition = fC(c(22,23,44,55,56,57,66)), 
...
# Text on other pages  -----------------------------------------
 ...
 conditionalPanel(condition = fC(c(33,45,44,55,56,57,66)),
                 paste('Note: All values <',criticalNumber,'including zeros are excluded '),style="color:green;font-weight: bold;")
 ,
 
 conditionalPanel(condition = fC(c(22,23,33,45,44,55,56,57,66)),
 ...
 tabPanel("Education Trend",
   ...
   tabPanel("SOCIAL DETERMINANTS",
    ...
    tabPanel("HOSPITAL DISCHARGE (1)",
          br(),
          plotlyOutput("OSHPD1", height=700),  value = 68),
