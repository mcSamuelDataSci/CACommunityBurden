...
# Input Selection on each tab  ----------------------------           
 ...
 conditionalPanel(condition = fC(c(22,23,44,55,66)),    
   actionButton("causeHelp", "?",style=myButtonSty) , 
 ...
 conditionalPanel(condition = fC(c(22,23)),
    actionButton("statecutHelp", "?",style=myButtonSty) ,
 ...
 conditionalPanel(condition = fC(c(22,23,34,44,55,66)), 
   actionButton( "measureHelp", "?",style=myButtonSty) ,
 ...
 # myCutSystem
 conditionalPanel(condition = fC(c(22,23)),
   actionButton("cutmethodHelp", "?",style=myButtonSty) ,
