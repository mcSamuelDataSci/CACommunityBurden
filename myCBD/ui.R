...
sidebarPanel( 
 ...
 conditionalPanel(condition = fC(c(33,34,5,55,6,7,8,9)),selectInput(  "myMeasure",  "Measure:", choices=lMeasures,selected="YLLper")),
 conditionalPanel(condition = fC(c(33,34)),                radioButtons( "myCutSystem","Cut-point method:", choices=c("pretty","quantile","fisher"))),
