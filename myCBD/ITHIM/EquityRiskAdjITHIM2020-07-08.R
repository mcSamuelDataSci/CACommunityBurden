...
# deaths$stateCode <- substr(deaths$CT,1,2)
# deaths$countyCode <- substr(deaths$CT,3,5)
# deaths$tractCode <- substr(deaths$CT,6,11)

# cbdDat0FULL <- deaths[, c("year", "tractCode", "countyCode", "stateCode",
#                         "age", "sex", "ICD10")]
...
securePath     <- "E:/CCB/0.Secure.Data/"
# securePath     <- "g:/CCB/0.Secure.Data/"
# securePath     <- "h:/0.Secure.Data/"
secureDataFile <- paste0(securePath,"myData/cbdDat0FULL.rds") 
...
# create census tract 
deaths$CT <-  with(deaths, paste0(GEOID))
