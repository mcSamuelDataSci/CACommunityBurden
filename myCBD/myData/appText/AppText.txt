...
<b>Years of Life Lost per 100,000 population</b> divides the YLL sum by the number of people in the population, then multiplies by 100,000 for interpretability. It is the YLL equivalent of the Death Rate
...
#I think this needs to be updated? Suggest not putting in a specific number) but rather brief overview of how the three levels of detail were constructed. Also note which levels are comprehensive and which only have certain conditions (only the most granular I recall).
