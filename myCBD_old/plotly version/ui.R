...
# Input selections on each tab  ----------------------------           
 ...
 # myCAUSE
 conditionalPanel(condition = fC(c(22,23,44,54,55,56,57,58,66)), 
   # first parameter of actionButton (inputId) generated by server.R
   actionButton(inputId="causeHelp", label="?",style=myButtonSty) , 
   dottedSelectInput("myCAUSE", HTML("Cause:"), choices=fullList)),    # , selected="0"
 
 # myLHJ

 conditionalPanel(condition = fC(c(15,22,23,33,44,45,54,55,56,57,58,68,69,70, 71)), 
